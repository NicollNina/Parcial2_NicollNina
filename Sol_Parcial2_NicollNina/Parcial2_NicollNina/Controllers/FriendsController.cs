...
using Parcial2_NicollNina.Data;
using Parcial2_NicollNina.Models;

namespace Parcial2_NicollNina.Controllers
{
    public class FriendsController : ApiController
    {
        private Parcial2_NicollNinaContext db = new Parcial2_NicollNinaContext();
